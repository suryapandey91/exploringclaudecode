    ...
    <>
      ...
      <section className="section wrap" id="resources">
        ...
        <div className="res-list r">
          <a
            href="mailto:surya.pandey62@gmail.com?subject=Resource%20request%3A%20Regulated-industry%20PM"
            className="res"
          >
            ...
            <div className="res-arr" aria-hidden="true">
              ↗
            </div>
          </a>

          <a
            href="mailto:surya.pandey62@gmail.com?subject=Resource%20request%3A%20AI%20PM%20fundamentals"
            className="res"
          >
          ...
          <a
            href="mailto:surya.pandey62@gmail.com?subject=Resource%20request%3A%20Your%20first%20data%20product"
            className="res"
          >
          ...
          <a
            href="mailto:surya.pandey62@gmail.com?subject=Resource%20request%3A%20Engineer%20to%20PM"
            className="res"
          >
            <div className="res-num">→ 04</div>
            <div>
              <h3 className="res-title">
                Engineer → PM, without losing your edge
              </h3>
              <p className="res-desc">
